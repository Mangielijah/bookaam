...
import com.omenacle.bookaam.ListAdapters.VIPLocationListAdapter;
 ...
 */
public class VIPLocationFragment extends Fragment {


    public VIPLocationFragment() {
    ...
    public static VIPLocationFragment newInstance(String key, String name) {
        VIPLocationFragment fragment = new VIPLocationFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        locationListAdapter = new VIPLocationListAdapter(mRouteList, mSeatList, locationRecyclerView, onLocationListener);
