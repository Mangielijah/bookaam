 ...
 */
public class BookVIPTicketFragment extends Fragment {


    public BookVIPTicketFragment() {
    ...
    ProgressDialog pd;
    VIPAgencyListAdapter mAgencyListAdapter = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAgencyListAdapter = new VIPAgencyListAdapter(mBusAgencyList, mAgencyRecyclerView);
