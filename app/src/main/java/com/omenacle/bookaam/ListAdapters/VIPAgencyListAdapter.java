...
import com.omenacle.bookaam.VIPBookingActivity;

import java.util.List;

public class VIPAgencyListAdapter extends RecyclerView.Adapter<VIPAgencyListAdapter.AgencyHolder> {
    ...
    public VIPAgencyListAdapter(List<Agency> agencies, RecyclerView mAgencyRecyclerView) {
     mAgencies = agencies;
        ...
        public AgencyHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent startBooking = new Intent(context, VIPBookingActivity.class);
